...
setup(
    ...
    packages = ['HangmanLibrary'],   # Chose the same as "name"
    ...
    download_url = 'https://github.com/GuiOliv/HangmanProject/archive/refs/tags/0.2.0.tar.gz',    # I explain this later on
)
